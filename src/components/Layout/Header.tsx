...
const Header: React.FC<HeaderProps> = ({ onMenuClick }) => {
  ...
  return (
    <>
      <header className="sticky top-0 z-40 bg-white/80 backdrop-blur-md shadow-sm border-b border-gray-200/50 px-4 lg:px-6 py-4">
            ...
            <div className="relative w-full">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl 
                         ...
                         text-sm text-gray-600 placeholder-gray-400 transition-all duration-200"
              />
            </div>
          </div>
